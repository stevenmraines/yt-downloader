...
@export var download_archive_file_path := "":
	set(value):
		download_archive_file_path = value
		if download_archive_file_path_input:
			download_archive_file_path_input.text = download_archive_file_path
...
@onready var download_archive_file_path_input := $VBoxContainer/HBoxContainer5/MarginContainer/DownloadArchiveFilePathInput
