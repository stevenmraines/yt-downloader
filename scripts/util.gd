...
static func yt_dlp_error_string(code : int) -> String:
	const YT_DLP_ERRORS := {
		0: "SUCCESS: The operation completed successfully.",
		1: "GENERIC_ERROR: Caught any unclassified error, network failure, or extractor issue.",
		2: "USER_ERROR: Syntax error or invalid options provided in the command line.",
		100: "UPDATE_RESTART: The program must restart to complete a self-update.",
		101: "DOWNLOAD_CANCELED: The download stopped due to limits like --max-downloads.",
	}
...
static func windows_error_string(code : int) -> String:
	const WINDOWS_ERRORS := {
		...
		51: "ERROR_REM_NOT_LIST: Windows cannot find the network path.",
		...
		71: "ERROR_REQ_NOT_ACCEP: No more connections can be made to this remote computer at this time.",
		...
		106: "ERROR_SEM_USER_LIMIT: Insert the diskette for drive.",
		...
		129: "ERROR_CHILD_NOT_COMPLETE: The application cannot be run in Win32 mode.",
		...
		182: "ERROR_INVALID_ORDINAL: The operating system cannot run the application.",
		...
		188: "ERROR_INVALID_STARTING_CODESEG: The operating system cannot run the application.",
		189: "ERROR_INVALID_STACKSEG: The operating system cannot run the application.",
		190: "ERROR_INVALID_MODULETYPE: The operating system cannot run the application.",
		191: "ERROR_INVALID_EXE_SIGNATURE: Cannot run the application in Win32 mode.",
		192: "ERROR_EXE_MARKED_INVALID: The operating system cannot run the application.",
		193: "ERROR_BAD_EXE_FORMAT: Not a valid Win32 application.",
		194: "ERROR_ITERATED_DATA_EXCEEDS_64k: The operating system cannot run the application.",
		195: "ERROR_INVALID_MINALLOCSIZE: The operating system cannot run the application.",
		...
		198: "ERROR_INVALID_SEGDPL: The operating system cannot run the application.",
		...
		201: "ERROR_RELOC_CHAIN_XEEDS_SEGLIM: The operating system cannot run the application.",
		202: "ERROR_INFLOOP_IN_RELOC_CHAIN: The operating system cannot run the application.",
		...
		216: "ERROR_EXE_MACHINE_TYPE_MISMATCH: This version of the application is not compatible with the version of Windows you're running.",
		217: "ERROR_EXE_CANNOT_MODIFY_SIGNED_BINARY: The image file is signed, unable to modify.",
		218: "ERROR_EXE_CANNOT_MODIFY_STRONG_SIGNED_BINARY: The image file is strong signed, unable to modify.",
		...
		224: "ERROR_FORMS_AUTH_REQUIRED: Access Denied. You must first add the web site to your trusted sites list.",
		...
		226: "ERROR_VIRUS_DELETED: This file contains a virus or potentially unwanted software and cannot be opened.",
		...
		306: "ERROR_SECURITY_STREAM_IS_INCONSISTENT: The security stream for the given volume is in an inconsistent state.",
		...
		317: "ERROR_MR_MID_NOT_FOUND: The system cannot find message text for the specified message number.",
		...
		324: "ERROR_INTERMIXED_KERNEL_EA_OPERATION: An attempt was made to modify both a KERNEL and normal Extended Attribute in the same operation.",
	...
	return WINDOWS_ERRORS.get(code, "Unknown error code: %d" % code)
